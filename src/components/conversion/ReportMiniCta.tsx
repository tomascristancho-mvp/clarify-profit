...
export function ReportMiniCta() {
  return (
    <div className="overflow-hidden rounded-xl border border-indigo-100 bg-gradient-to-br from-indigo-50/70 to-white shadow-sm dark:border-indigo-900 dark:from-indigo-950/50 dark:to-slate-900">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <ul className="space-y-1.5" role="list">
            {BENEFITS.map((benefit) => (
              <li key={benefit} className="flex items-center gap-1.5 text-xs text-slate-600 dark:text-slate-300">
