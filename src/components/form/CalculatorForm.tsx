...
export function CalculatorForm({
  ...
  return (
    ...
    >
      {/* Microcopy introductorio */}
      <p className="text-sm text-slate-500">
        Ingresa los datos de tu negocio.{" "}
        <span className="font-medium text-slate-600">Cálculo local e inmediato</span>
        {" "}— sin registro ni carga de archivos.
      </p>
